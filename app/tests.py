...
class TestModels(TestCase):
    ...
    def test_park(self):
        ...
        db.create_all()
        park = Park(
            "Park", "13.87", "125.64", "2419 Rio Grande", "(555)-555-5555",
                    "3.5", "google.com", "78705", "google.com", "787", "Texas")
        db.session.add(park)
        db.session.commit()
    ...
    def test_park2(self):
        ...
        db.create_all()
        park = Park(
            "Park2", "13.87", "125.64", "2317 Speedway", "(555)-555-5555",
            "3.5", "google.com", "78705", "google.com", "787", "Texas")
        db.session.add(park)
        db.session.commit()
        parks = Park.query.all()
    ...
    def test_park3(self):
        ...
        db.create_all()
        park = Park(
            "Park3", "13.87", "125.64", "2419 Rio Grande", "(555)-555-5555",
            "3.5", "google.com", "78705", "google.com", "787", "Texas")
        db.session.add(park)
        db.session.commit()
        parks = Park.query.all()
    ...
    def test_campground(self):
        ...
        campground = Campground("Camping", "tents", "45.38", "-53.87",
                                "go right", "(555)-555-5555", "contact@gmail.com", "78705", None)
    ...
    def test_campground2(self):
        ...
        campground = Campground("Everglades", "lodge", "145.38", "42.45",
                                "go straight", "(555)-555-5555", "contact@gmail.com", "78705", None)
        db.session.add(campground)
        db.session.commit()
        campgrounds = Campground.query.all()
        self.assertTrue(campground in campgrounds)
    ...
    def test_campground3(self):
        ...
        campground = Campground("Yosemite", "RVs", "46.15", "-53.87",
                                "go left", "(555)-555-5555", "contact@gmail.com", "78705", None)
        db.session.add(campground)
        db.session.commit()
        campgrounds = Campground.query.all()
        self.assertTrue(campground in campgrounds)
    ...
    def test_event(self):
        ...
        db.create_all()
        event = Event(
            "124.56", "-26.76", "Running", "2/5/17", "2/6/17", "google.com",
                      "Relay for Life", "(555)-555-5555", "Austin", "78705", "787", "Texas")
    ...
    def test_event2(self):
        ...
        db.create_all()
        event = Event(
            "124.56", "-26.76", "Biking", "1/1/17", "1/2/17", "google.com",
                      "Living Water International", "(555)-555-5555", "Austin", "78705", "787", "Texas")
        db.session.add(event)
        db.session.commit()
        events = Event.query.all()
        self.assertTrue(event in events)
    ...
    def test_event3(self):
        ...
        db.create_all()
        event = Event(
            "124.56", "-26.76", "Hiking", "2/5/17", "2/6/17", "google.com",
                      "Crohns and Colitis Foundation", "(555)-555-5555", "Austin", "78705", "787", "Texas")
        db.session.add(event)
        db.session.commit()
        events = Event.query.all()
        self.assertTrue(event in events)
